	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Comment</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
				...
				<div class="col-sm-6 col-xxl-3">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-footer d-flex flex-stack pt-0">
							<!--begin::Link-->
							<?
							$total_comment = count_any_table(array('kit_id' => $kit['id'], 'view' => '0'), 'comment');
							?>
							<a class=" flex-shrink-0 me-2"><span class="badge badge-warning"><?=$total_comment?> Comment</span></a>
							<!--end::Link-->
							<!--begin::Link-->
							<a class="btn btn-sm btn-primary flex-shrink-0" href="<?=base_url('office/viewComment/'.$kit['id'])?>" data-init="<?=$kit['id']?>">View Comment</a>
							<!--end::Link-->
						</div>
						<!--end::Footer-->
					</div>
