				...
				<div class="col-sm-6 col-xxl-3">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-footer d-flex flex-stack pt-0">
							<!--begin::Link-->
							<a class="flex-shrink-0 delete-kit flex-shrink-0 me-2"></a>
							<!--end::Link-->
							<!--begin::Link-->
							<a class="btn btn-sm btn-primary flex-shrink-0 give-comment" href="<?=base_url('app/commentPages/'.$kit['id'])?>">Comment</a>
							<!--end::Link-->
						</div>
						<!--end::Footer-->
					</div>
