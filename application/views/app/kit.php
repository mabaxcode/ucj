	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Kit List</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
					...
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-muted">Kit List</li>
					<!--end::Item-->
				</ul>
				<!--end::Breadcrumb-->
			</div>
				...
				<div class="col-sm-6 col-xxl-3">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-footer d-flex flex-stack pt-0">
							<!--begin::Link-->
							<a class="btn btn-sm btn-secondary flex-shrink-0 delete-kit flex-shrink-0 me-2" href="<?=base_url('app/configurator')?>" target="_blank">Custom</a>
							<!--end::Link-->
							<!--begin::Link-->
