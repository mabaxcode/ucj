							...
							<div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
								...
								<div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
										<!--begin:Menu link-->
										<a class="menu-link" href="<?=base_url('app/configurator')?>" target="_blank">
									...
									<!--end:Menu item-->
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2 <? if($this->uri->segment(2) == 'kit'){echo "here";} ?>">
										<!--begin:Menu link-->
										<a class="menu-link" href="<?=base_url('app/kit')?>">
											<span class="menu-title">Kit List</span>
											<span class="menu-arrow d-lg-none"></span>
										</a>
										<!--end:Menu link-->
									</div>
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2 <? if($this->uri->segment(2) == 'template'){echo "here";} ?>">
										<!--begin:Menu link-->
										<a class="menu-link" href="<?=base_url('app/template')?>">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2 <? if($this->uri->segment(2) == 'comment'){echo "here";} ?>">
										<!--begin:Menu link-->
										<a class="menu-link" href="<?=base_url('app/comment')?>">
									...
									<?/*
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2 <? if($this->uri->segment(2) == 'order'){echo "here";} ?>">
										<!--begin:Menu link-->
										<a class="menu-link" href="<?=base_url('app/order')?>">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
										...
										<span class="menu-link">
											<span class="menu-title">My Jersey</span>
											<span class="menu-arrow d-lg-none"></span>
										</span>
										<!--end:Menu link-->
									</div>
									...
									*/?>
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 <? if($this->uri->segment(2) == 'order' || $this->uri->segment(2) == 'orderComplete'){echo "here";} ?>">
										<!--begin:Menu link-->
										<span class="menu-link">
										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link add-new-order" href="#">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="<?=base_url('app/order')?>">
													<span class="menu-title">Submited Order</span>
												</a>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="<?=base_url('app/orderComplete')?>">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5 my-1">
											<a href="<?=base_url('app/setting')?>" class="menu-link px-5">Account Settings</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-5">
